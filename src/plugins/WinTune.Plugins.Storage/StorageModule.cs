...
public sealed class StorageModule : IOptimizerModule
{
    private readonly ILogger<StorageModule> _log;
    private readonly IScanTask[] _tasks;

    public ModuleMetadata Metadata { get; } = new(
        Id: "wintune.storage",
        DisplayName: "Almacenamiento",
        Description: "Detecta archivos grandes, papelera llena y componentes WinSxS hinchados.",
    ...
    public StorageModule(ILogger<StorageModule> log)
    {
        _log = log;
        _tasks =
        [
